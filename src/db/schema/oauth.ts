...
/**
 * Tables for the OAuth 2.1 provider behind the MCP server
 * (@better-auth/mcp → @better-auth/oauth-provider) plus the jwt plugin's
 * signing keys. Field lists mirror the plugins' schema definitions.
 */
